/* ============================================================
   slide-3.js — 슬라이드 3 (솔루션 · B-EMS → C-EMS) 애니메이션
...
window.AiceSlide3 = (function () {
  ...
  function buildCity() {
    var tilt = document.getElementById('s3-tilt');
    if (!tilt) return;
    tilt.innerHTML = '';
  ...
  /* ============================================================
     ...
     ============================================================ */
  function build() {
    var world = document.getElementById('s3-world');
    var spot = document.querySelector('#slide-3 .bg-spot');
    var ems = document.getElementById('s3-ems');
    var kicker = document.getElementById('s3-bems-kicker');
    var sub = document.getElementById('s3-cems-sub');
    var stats = document.getElementById('s3-cems-stats');
    var buildingHud = document.getElementById('s3-building-hud');
    var panelL = document.querySelector('#slide-3 .panel-left');
    var panelR = document.querySelector('#slide-3 .panel-right');
    var profile = document.querySelector('#slide-3 .building-profile');
    var calloutDot = document.querySelector('#slide-3 .callout-dot');
    var calloutLine = document.querySelector('#slide-3 .callout-line');
    var calloutLabel = document.querySelector('#slide-3 .callout-label');
    var panelItems = document.querySelectorAll(
      '#slide-3 .panel-tag, #slide-3 .stat, #slide-3 .spark, #slide-3 .load-row, #slide-3 .gauge');
    var loadBars = document.querySelectorAll('#slide-3 .load-track i');
    var statVals = document.querySelectorAll('#slide-3 .stat-val');
    var gaugeNum = document.querySelector('#slide-3 .gauge-num');
    var sparkLine = document.querySelector('#slide-3 .spark-line');
    var sparkArea = document.querySelector('#slide-3 .spark-area');
    var sparkDot = document.querySelector('#slide-3 .spark-dot');
    var gaugeFill = document.querySelector('#slide-3 .gauge-fill');
    var chB = document.querySelector('#slide-3 .ch-b');
    var chC = document.querySelector('#slide-3 .ch-c');
