/* ============================================================
   ...
   끝까지 남는 키워드는 "전략".
   전역 객체 AiceSlide8 { init, replay } 노출
   ============================================================ */
window.AiceSlide8 = (function () {
  'use strict';
  ...
  function makeParticles() {
    var pc = document.getElementById('s8-particles');
    if (!pc) return;
    pc.innerHTML = '';
    for (var i = 0; i < 14; i++) {
  ...
  /* ============================================================
     ...
     ============================================================ */
  function buildQuads() {
    var quads = document.querySelectorAll('#s8-swot .quad');
  ...
  /* ============================================================
     ...
     ============================================================ */
  function build() {
    var eyebrow = document.getElementById('s8-eyebrow');
    var spot    = document.querySelector('#slide-8 .bg-spot');
    var frame   = document.querySelector('#s8-swot .swot-frame');
    var divH    = document.querySelector('#s8-swot .div-h');
    var divV    = document.querySelector('#s8-swot .div-v');
    var node    = document.querySelector('#s8-swot .node');
    var quads   = document.querySelectorAll('#s8-swot .quad');
    var kicker  = document.getElementById('s8-kicker');
  ...
  function bindClicks() {
    ...
    var slide = document.getElementById('slide-8');
    if (slide) {
  ...
  function focusQuad(target) {
    var swot = document.getElementById('s8-swot');
    var quads = document.querySelectorAll('#s8-swot .quad');
    for (var i = 0; i < quads.length; i++) {
      var el = quads[i];
      if (el === target) {
  ...
  function observe() {
    var el = document.getElementById('slide-8');
    if (!el) return;
