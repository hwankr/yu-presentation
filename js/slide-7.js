/* ============================================================
   slide-7.js — 슬라이드 7 (측정 · 피터 드러커 인용) 애니메이션
...
window.AiceSlide7 = (function () {
  ...
  function guardImage() {
    var img = document.querySelector('#slide-7 .portrait-img');
    if (!img) return;
  ...
  function build() {
    ...
    var rule   = document.querySelector('#slide-7 .attr-rule');
    var attrEl = document.querySelectorAll('#slide-7 .attr-name, #slide-7 .attr-role');
    var mark   = document.querySelector('#slide-7 .saying .mark');
    var lines  = document.querySelectorAll('#slide-7 .saying .line');
    var saying = document.querySelector('#slide-7 .saying');

    var kwAll     = document.querySelectorAll('#slide-7 .saying .kw');
    var kwMeasure = document.querySelectorAll('#slide-7 .saying .kw[data-kw="measure"]');
    var kwManage  = document.querySelectorAll('#slide-7 .saying .kw[data-kw="manage"]');
    var kwImprove = document.querySelectorAll('#slide-7 .saying .kw[data-kw="improve"]');
